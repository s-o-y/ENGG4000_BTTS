...
# Description:
#	Code to implement test AFAS-ACT-01.
#	Tests the full focusing time of the system.
#	Only runs the focusing code once and uses tic tocs to
#	determine focusing time.
#
...
def toc2(tempBool=True):
    ...
    if tempBool:
        print("Loop Time: %f seconds." %tempTimeInterval)
